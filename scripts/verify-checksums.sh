...
expected="$(mktemp "${TMPDIR:-/tmp}/docprims-checksum-expected.XXXXXX")"
actual="$(mktemp "${TMPDIR:-/tmp}/docprims-checksum-actual.XXXXXX")"
...
validate_all_cli_archives "$directory"
