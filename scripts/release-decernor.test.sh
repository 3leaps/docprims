...
mkdir -p "$fixture/repo/scripts" "$fixture/repo/docs/security" "$fixture/repo/schemas/release" "$fixture/repo/keys" "$fixture/home" "$fixture/other-home" "$fixture/export"
...
cp "$root/schemas/release/fingerprint-record.v0.schema.json" "$fixture/repo/schemas/release/"
bin="${DOCPRIMS_DECERNOR_BIN:-$(command -v decernor)}"
[[ "$bin" == /* ]]
fail() {
...
PY
export DOCPRIMS_MINISIGN_PUB="$fixture/public.pub"
export DOCPRIMS_DECERNOR_BIN="$bin"
(
...
cp "$fixture/repo/docs/security/release-signing-keys.asc" "$fixture/export/docprims-release-signing-key.asc"
cp "$fixture/public.pub" "$fixture/export/docprims-minisign.pub"
"$fixture/repo/scripts/verify-public-keys.sh" "$fixture/export" >/dev/null

fail env -u DOCPRIMS_DECERNOR_BIN DECERNOR_BIN="$bin" "$fixture/repo/scripts/verify-public-keys.sh" "$fixture/export"
fail env -u DOCPRIMS_DECERNOR_BIN DECERNOR_BIN="$bin" "$fixture/repo/scripts/release-insert-anchors.sh"
fail env DOCPRIMS_DECERNOR_BIN=decernor "$fixture/repo/scripts/verify-public-keys.sh" "$fixture/export"
fail env DOCPRIMS_DECERNOR_BIN="$fixture/missing" "$fixture/repo/scripts/verify-public-keys.sh" "$fixture/export"
...
fail env DOCPRIMS_DECERNOR_BIN="$fixture/false-version" "$fixture/repo/scripts/verify-public-keys.sh" "$fixture/export"
sed 's/0\.1\.8/0.1.7/' "$fixture/false-version" >"$fixture/old-version"
chmod +x "$fixture/old-version"
fail env DOCPRIMS_DECERNOR_BIN="$fixture/old-version" "$fixture/repo/scripts/verify-public-keys.sh" "$fixture/export"
sed 's/decernor 0.1.8/other 0.1.8/' "$fixture/false-version" >"$fixture/wrong-identity"
chmod +x "$fixture/wrong-identity"
fail env DOCPRIMS_DECERNOR_BIN="$fixture/wrong-identity" "$fixture/repo/scripts/verify-public-keys.sh" "$fixture/export"
...
rm "$fixture/export/docprims-minisign.pub"
fail "$fixture/repo/scripts/verify-public-keys.sh" "$fixture/export"
cp "$fixture/public.pub" "$fixture/export/docprims-minisign.pub"
cp "$fixture/other.pub" "$fixture/export/docprims-minisign.pub"
fail "$fixture/repo/scripts/verify-public-keys.sh" "$fixture/export"
cp "$fixture/public.pub" "$fixture/export/docprims-minisign.pub"
...
gpg --homedir "$fixture/other-home" --batch --armor --export >"$fixture/export/docprims-release-signing-key.asc"
fail "$fixture/repo/scripts/verify-public-keys.sh" "$fixture/export"
gpg --homedir "$fixture/home" --batch --import "$fixture/export/docprims-release-signing-key.asc" >/dev/null 2>&1
gpg --homedir "$fixture/home" --batch --armor --export >"$fixture/export/docprims-release-signing-key.asc"
fail "$fixture/repo/scripts/verify-public-keys.sh" "$fixture/export"
cp "$fixture/repo/docs/security/release-signing-keys.asc" "$fixture/export/docprims-release-signing-key.asc"
truncate -s 0 "$fixture/export/docprims-release-signing-key.asc"
fail "$fixture/repo/scripts/verify-public-keys.sh" "$fixture/export"
cp "$fixture/repo/docs/security/release-signing-keys.asc" "$fixture/export/docprims-release-signing-key.asc"
...
DOCPRIMS_MINISIGN_PUB="$fixture/other.pub" "$fixture/repo/scripts/release-insert-anchors.sh" >/dev/null
...
fail env DOCPRIMS_DECERNOR_BIN="$fixture/reject-verify" "$fixture/repo/scripts/release-insert-anchors.sh"
